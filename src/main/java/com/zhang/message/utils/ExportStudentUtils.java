package com.zhang.message.utils;
...
public class ExportStudentUtils {
    ...
    public static ByteArrayOutputStream exportStudent(List<BusStudent> students, String sheetName) {
        ...
        //1.8.1第三行
        String[] titles = {"学号", "学生姓名", "班级代号", "学生性别", "学院名称",  "录入时间"};
        index++;
        ...
        for (int i = 0; i < students.size(); i++) {
            ...
            //1.9.1创建列学生性别
            HSSFCell row_sex = row.createCell(3);
            ...
            row_career.setCellValue(student.getDepartment());
